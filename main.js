...
window.EXTRACT_URL =
  "https://us-central1-class-central-prod.cloudfunctions.net/extract";

CC.data = CC.data || {};
CC.data.googleAuthClientId =
  "800843789351-uaenl03be56t7l8l8be0ms54n7kc0al4.apps.googleusercontent.com";
CC.data.page = "home";
...
doce.addEventListener("mouseenter", function () {
  once.style.display = "block";
});

doce.addEventListener("mouseleave", function () {
    ...
    e = {
      ...
      6693: function (t, e, n) {
        ...
        class c {
          ...
          async createRequest(t, e, n, r) {
            ...
            null !== n && (u.body = n);
            const s = await fetch(e, { ...u, ...c });
            if (!s.ok)
              throw s.status >= 400 && s.status <= 499
                ? new a(s)
                : s.status >= 500 && s.status <= 599
                ? new i(s)
                : new o(s);
            return s;
          }
              ...
              : (async function (t, e, n) {
                  ...
                  for (let n = 0; i < r; ) {
                    ...
                    r.append("chunk", e.slice(i, c)),
                      r.append("index", n),
                      r.append("id", a);
                    const u = await t.post("/user/upload-file-chunk", null, r);
                    (a = (await u.json()).id), (i = c), (c = i + o), (n += 1);
                  }
                  const u = new FormData();
                  return (
                    u.append("id", a),
                    u.append("filename", e.name),
                    u.append("type", n),
                    t.post("/user/assemble-file", null, u)
                  );
                })(this.httpClient, t, e);
          }
        }
      ...
      2385: function (t, e, n) {
        ...
        e.Z = (t, e) => {
          ...
          for (const [t, i] of Object.entries(e)) {
            ...
            const u = () => {
              a(c, t), c.removeEventListener("input", u);
            };
        ...
        t.exports = (function () {
          ...
          function J() {
            ...
            var ot = $(K, n),
              ...
              ut = it.createNodeIterator,
              st = it.createDocumentFragment,
              ...
              ie = function (t) {
                (re && re === t) ||
                  ((t && "object" === (void 0 === t ? "undefined" : q(t))) ||
                    (t = {}),
                  (t = O(t)),
                  (Et = "ALLOWED_TAGS" in t ? _({}, t.ALLOWED_TAGS) : xt),
                  ...
                  Zt &&
                    ((Et = _({}, [].concat(V(D)))),
                    (Tt = []),
                    !0 === Zt.html && (_(Et, A), _(Tt, I)),
                    !0 === Zt.svg && (_(Et, j), _(Tt, R), _(Tt, M)),
                    !0 === Zt.svgFilters && (_(Et, k), _(Tt, R), _(Tt, M)),
                    !0 === Zt.mathMl && (_(Et, C), _(Tt, P), _(Tt, M))),
                  t.ADD_TAGS && (Et === xt && (Et = O(Et)), _(Et, t.ADD_TAGS)),
                  t.ADD_ATTR && (Tt === _t && (Tt = O(Tt)), _(Tt, t.ADD_ATTR)),
                  t.ADD_URI_SAFE_ATTR && _(qt, t.ADD_URI_SAFE_ATTR),
                  t.FORBID_CONTENTS &&
                    (zt === Ht && (zt = O(zt)), _(zt, t.FORBID_CONTENTS)),
                  Ft && (Et["#text"] = !0),
                  Nt && _(Et, ["html", "head", "body"]),
                  Et.table && (_(Et, ["tbody"]), delete St.tbody),
                  i && i(t),
                  (re = t));
              },
              ce = _({}, ["mi", "mo", "mn", "ms", "mtext"]),
              ue = _({}, ["foreignobject", "desc", "title", "annotation-xml"]),
              se = _({}, j);
            _(se, k), _(se, L);
            var le = _({}, C);
            _(le, N);
                ...
                if (i) {
                  ...
                  for (a = i.length; a--; ) {
                    ...
                    if (
                      ...
                      (r = c.attrValue),
                      !c.forceKeepAttr && (pe(s, t), c.keepAttr))
                    )
                      if (w(/\/>/i, r)) pe(s, t);
                      else {
            ...
            return (
              (e.sanitize = function (r, a) {
                ...
                if (
                  ...
                  (1 ===
                    (u = (i = he("\x3c!----\x3e")).ownerDocument.importNode(
                      r,
                      !0
                    )).nodeType &&
                    "BODY" === u.nodeName) ||
                  ...
                  if (!Rt && !Ct && !Nt && -1 === r.indexOf("<"))
                    return ot && Mt ? ot.createHTML(r) : r;
                  if (!(i = he(r))) return Rt ? null : Mt ? at : "";
                }
                i && It && de(i.firstChild);
                for (var p = me(Gt ? r : i); (s = p.nextNode()); )
                  (3 === s.nodeType && s === l) ||
                    be(s) ||
                    (s.content instanceof o && Te(s.content), xe(s), (l = s));
                ...
                return (
                  Nt &&
                    ...
                    w(B, i.ownerDocument.doctype.name) &&
                    (h =
      ...
      2772: function (t, e, n) {
        ...
        t.exports = function (t, e, n, m, v, g) {
          ...
          if (_ && !x)
            return (
              g || (g = new r()),
              y || l(t) ? o(t, e, n, m, v, g) : a(t, e, w, n, m, v, g)
            );
          if (!(1 & n)) {
      ...
      7042: function (t, e, n) {
        var r = n(2485),
          o = n(756),
          a = n(5581);
        t.exports = function (t, e, n, i, c, u) {
          var s = 1 & n,
            l = t.length,
            f = e.length;
          ...
          for (u.set(t, e), u.set(e, t); ++h < l; ) {
            var g = t[h],
              y = e[h];
            if (i) var b = s ? i(y, g, h, e, t, u) : i(g, y, h, t, e, u);
            if (void 0 !== b) {
              if (b) continue;
              m = !1;
              break;
      ...
      370: function (t, e, n) {
        ...
        t.exports = function (t, e, n, r, s, f, d) {
          switch (n) {
            ...
            case "[object Set]":
              var h = 1 & r;
              if ((p || (p = u), t.size != e.size && !h)) return !1;
              var m = d.get(t);
              if (m) return m == e;
              (r |= 2), d.set(t, e);
              var v = i(p(t), p(e), r, s, f, d);
              return d.delete(t), v;
            case "[object Symbol]":
      ...
      9584: function (t, e, n) {
        ...
        t.exports = function (t, e, n, a, i, c) {
          ...
          for (var v = u; ++f < l; ) {
            var g = t[(d = s[f])],
              y = e[d];
            if (a) var b = u ? a(y, g, d, e, t, c) : a(g, y, d, t, e, c);
      ...
      1871: function (t, e, n) {
        ...
        t.exports = function (t, e, n) {
          return (
            ...
            function () {
              for (
                var a = arguments, i = -1, c = o(a.length - e, 0), u = Array(c);
                ++i < c;
      ...
      6726: function (t, e, n) {
        ...
        t.exports = function (t, e, n) {
          ...
          function y(e) {
            var n = u,
              r = s;
            return (u = s = void 0), (h = e), (f = t.apply(r, n));
          }
          function b(t) {
            return (h = t), (d = setTimeout(E, e)), m ? y(t) : f;
          }
          function w(t) {
            var n = t - p;
          ...
          function T() {
            ...
            if (((u = arguments), (s = this), (p = t), n)) {
              ...
              if (v) return clearTimeout(d), (d = setTimeout(E, e)), y(p);
            }
            ...
            case "load:WINDOW":
              u("UserActions"),
                ...
                window.location.pathname.match(/\/cohorts\/[a-zA-Z0-9\-]+$/) &&
                  c("StudyGroups"),
                o.px("[data-name=EDIT_PROFILE]").then(() => u("Profile")),
                o.px("[data-name=PROFILE_FORM]").then(() => u("Profile")),
                window.location.pathname.match(
...
window.CC.Class.Analytics = new window.Analytics({
  url: "",
  indexes: { weekly: "2023_03_19", monthly: "2023_03" },
  ...
  globalProps: {
    ...
    user: [],
    metadata: [],
    original_referer: "www_classcentral_com",
    created: "2023-03-22T15:36:57+00:00",
    referrer_info: {
      referrer: "https://www.classcentral.com/login",
      source: null,
      term: null,
      medium: null,
    },
    ...
    user_agent: {
      browser: { family: "Chrome", major: "111", minor: "0", patch: "0" },
      os: {
        family: "Windows",
        major: "10",
        minor: "",
